...
const commands = [
  ...
  new SlashCommandBuilder().setName('manage').setDescription('Gestion avancee du serveur')
    ...
    .addSubcommandGroup(g => g.setName('birthday').setDescription('Anniversaires')
      .addSubcommand(s => s.setName('set').setDescription('Definir ton anniversaire').addStringOption(o => o.setName('date').setDescription('Date JJ/MM (ex: 25/12)').setRequired(true)))
